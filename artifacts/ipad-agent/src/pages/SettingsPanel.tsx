...
import { Save, Smartphone, Info, Wifi, WifiOff } from "lucide-react";
          ...
          <div className="space-y-5">
            ...
            {guide?.webhookUrl && (
              <div className="panel p-4">
                ...
                <p className="text-[10px] text-muted-foreground mt-2">Use this URL in your Apple Shortcut to send Safari data to the agent.</p>
              </div>
            )}
